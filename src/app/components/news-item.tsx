...
export default function NewsItem({
  ...
  return (
    <li className="flex flex-col max-w-[335px] md:max-w-[340px] lg:max-w-[361px] justify-self-center">
      <div className="relative overflow-hidden rounded-[30px] max-w-[335px] h-[190px] mb-[20px] md:mb-[28px] md:rounded-[15px] md:max-w-[340px] md:h-[226px] lg:max-w-[361px]">
